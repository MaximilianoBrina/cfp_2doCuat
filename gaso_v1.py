"""Separador en sílabas + traductor a rosarigasino v.1
mejoras de la versión:
-ya no hay limitación mínima de extensión de palabras
-diccionario colaborativo de palabras/silabas"""
